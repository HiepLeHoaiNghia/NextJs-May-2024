...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & { isOpen?: boolean }
>(({ className, children, isOpen, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      {isOpen ? <ChevronUp className='h-4 w-4 opacity-100' /> : <ChevronDown className='h-4 w-4 opacity-70' />}
...
const SelectContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { scrollable?: boolean }
>(({ className, children, position = 'popper', scrollable, ...props }, ref) => (
