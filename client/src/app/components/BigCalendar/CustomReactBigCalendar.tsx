...
import { CalendarDialog } from '~/app/components/BigCalendar/components/CalendarDialog'
import { type CalendarDialogProps } from '~/app/components/BigCalendar/components/CalendarDialog/CalendarDialog'
import {
  CommonEventView,
  type CommonEventViewProps
} from '~/app/components/BigCalendar/components/CommonEventView/CommonEventView'
import {
  CustomToolBar,
  type CustomToolBarProps
} from '~/app/components/BigCalendar/components/CustomToolBar/CustomToolBar'
import {
  type CustomDateCellHeaderProps,
  DateCellHeader
} from '~/app/components/BigCalendar/components/DateCellHeader/DateCellHeader'
import {
  type CustomDateCellWrapperProps,
  DateCellWrapper
} from '~/app/components/BigCalendar/components/DateCellWrapper/DateCellWrapper'
import {
  EventWrapperView,
  type EventWrapperViewProps
} from '~/app/components/BigCalendar/components/EventWrapperView/EventWrapperView'
import LanguageSelector from '~/app/components/BigCalendar/components/LanguageSelector'
import {
  MonthEventView,
  type MonthEventViewProps
} from '~/app/components/BigCalendar/components/MonthEventView/MonthEventView'
...
import { getLocalesLanguageConfig } from '~/app/components/BigCalendar/utils'
import { RequestStatus, type RequestType } from '~/app/core/enums'
