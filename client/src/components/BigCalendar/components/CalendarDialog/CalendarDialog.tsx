...
import { CalendarForm } from '~/components/BigCalendar/components/CalendarForm/CalendarForm'
...
type CalendarDialogProps = Partial<BigCalendarContextType> & {
  className?: string
}
...
export { CalendarDialog, type CalendarDialogProps }
