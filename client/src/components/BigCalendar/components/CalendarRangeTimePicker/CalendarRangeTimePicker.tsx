...
import { CalendarDateTimePicker } from '~/components/BigCalendar/components/CalendarDateTimePicker/CalendarDateTimePicker'
...
import { formatDateByLanguage } from '~/components/BigCalendar/utils'
...
const CalendarRangeTimePicker = (props: CalendarRangeTimePickerProps) => {
  const {
    dialogState,
    selectedEvent,
    currentLanguage,
...
export { CalendarRangeTimePicker }
