...
import { type CalendarEvent, type LocaleCode } from '~/components/BigCalendar/types'
import { CustomSelect } from '~/components/CustomSelect/CustomSelect'

type CustomToolBarProps = Partial<ToolbarProps<CalendarEvent>> & {
  date: Date
...
export { CustomToolBar, type CustomToolBarProps }
